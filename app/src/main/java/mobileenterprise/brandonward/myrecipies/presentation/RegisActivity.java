...
public class RegisActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        self = this;
        listView = (ListView) findViewById(R.id.regisDataList);
        new RegisAsyncTask().execute("Brandon");
    }
    ...
    private class RegisAsyncTask extends AsyncTask<String, String, String> {//(params, progress-information, result) for arguments
